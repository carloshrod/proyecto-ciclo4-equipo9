...
const TableUsersRow = ({ user, setDataToEdit, deleteData }) => {
    let { _id,nro_registro, nombre,apellidos, nro_doc, email, telefono } = user || {};
    ...
    return (
        <tr>
            ...
            <td align="center">
                ...
                &nbsp;
                <button className="btn btn-danger" onClick={() => deleteData(_id)}><i className="bi bi-trash"></i></button>
            </td>
        </tr>
    );
};
