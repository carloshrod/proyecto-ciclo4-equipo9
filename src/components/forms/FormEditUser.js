...
import { initialForm } from './FormCreateUser';

function FormEditUser({ updateData, dataToEdit }) {
                    ...
                    <div className="card">
                        ...
                        <h5 className="card-title">Nombre del Usuario</h5>
                            ...
                            <form className="row g-3 needs-validation" onSubmit={handleSubmit} noValidate>
                                ...
                                <div className="col-6">
                                    <label for="yourUsername" className="form-label">Nro. Documento</label>
                                    <div className="input-group has-validation">
                                        <span className="input-group-text" id="inputGroupPrepend"><i className="bi bi-person-fill"></i></span>
                                        <input type="text" name="nro_doc" className="form-control" id="yourUsername" onChange={handleChange} value={form.nro_doc} required/>
